...
namespace SharpBox.SVC.Framework
{
    ...
    public class WindowsServiceAttribute : Attribute
    {
        ...
        /// <summary>
        /// True if service can handle power events (defaults to false).
        /// </summary>
        public bool CanHandlePowerEvent { get; set; }

        /// <summary>
        /// True if service can handle session changes from a terminal server session (defaults to false).
        /// </summary>
